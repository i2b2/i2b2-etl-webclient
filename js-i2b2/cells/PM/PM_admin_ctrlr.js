...
i2b2.PM.admin.saveProjectUser = function() {
	...
	if ( $('RoleDATA_AUTHOR').checked) {
		i2b2.PM.ajax.setRole("PM:Admin", {user_id: i2b2.PM.view.admin.currentProject.i2b2NodeUsername, user_role: "DATA_AUTHOR", project_id:i2b2.PM.view.admin.currentProject.i2b2NodeKey});
	} else {
		i2b2.PM.ajax.deleteRole("PM:Admin", {user_id: i2b2.PM.view.admin.currentProject.i2b2NodeUsername, user_role: "DATA_AUTHOR", project_id:i2b2.PM.view.admin.currentProject.i2b2NodeKey});		
	}

	if ( $('RolePATIENT_FACT_VIEWER').checked) {
		i2b2.PM.ajax.setRole("PM:Admin", {user_id: i2b2.PM.view.admin.currentProject.i2b2NodeUsername, user_role: "PATIENT_FACT_VIEWER", project_id:i2b2.PM.view.admin.currentProject.i2b2NodeKey});
	} else {
		i2b2.PM.ajax.deleteRole("PM:Admin", {user_id: i2b2.PM.view.admin.currentProject.i2b2NodeUsername, user_role: "PATIENT_FACT_VIEWER", project_id:i2b2.PM.view.admin.currentProject.i2b2NodeKey});		
	}

	if ( $('RolePOPULATION_FACT_VIEWER').checked) {
		i2b2.PM.ajax.setRole("PM:Admin", {user_id: i2b2.PM.view.admin.currentProject.i2b2NodeUsername, user_role: "POPULATION_FACT_VIEWER", project_id:i2b2.PM.view.admin.currentProject.i2b2NodeKey});
	} else {
		i2b2.PM.ajax.deleteRole("PM:Admin", {user_id: i2b2.PM.view.admin.currentProject.i2b2NodeUsername, user_role: "POPULATION_FACT_VIEWER", project_id:i2b2.PM.view.admin.currentProject.i2b2NodeKey});		
	}
...
i2b2.PM.admin.deleteProjectUser = function() {
	...
	var result = i2b2.PM.ajax.deleteRole("PM:Admin", {user_id: i2b2.PM.view.admin.currentProject.i2b2NodeUsername, user_role: "DATA_AUTHOR", project_id:i2b2.PM.view.admin.currentProject.i2b2NodeKey});
	var result = i2b2.PM.ajax.deleteRole("PM:Admin", {user_id: i2b2.PM.view.admin.currentProject.i2b2NodeUsername, user_role: "PATIENT_FACT_VIEWER", project_id:i2b2.PM.view.admin.currentProject.i2b2NodeKey});
	var result = i2b2.PM.ajax.deleteRole("PM:Admin", {user_id: i2b2.PM.view.admin.currentProject.i2b2NodeUsername, user_role: "POPULATION_FACT_VIEWER", project_id:i2b2.PM.view.admin.currentProject.i2b2NodeKey});
