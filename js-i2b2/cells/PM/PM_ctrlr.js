...
i2b2.PM._processUserConfig = function (data) {
	...
	try {
		...
		// Login code added
		var loginSessionId = t.innerHTML;
		i2b2.PM.setSession = loginSessionId.substring(loginSessionId.indexOf(":") + 1);
	 ...
	 if (!i2b2.PM.model.isAdmin && i2b2.PM.model.admin_only)
	{
		...
		i2b2.PM.view.mLog.commonCode(i2b2.PM.setSession, i2b2.PM.model.login_username, i2b2.PM.model.login_project);
	} else {
...
i2b2.PM.view.modal.projectDialog = {
	...
	loadProject: function(ProjId) {
		if (!ProjId) {
			...
			// Login code added 
			i2b2.PM.view.mLog.commonCode(i2b2.PM.setSession, i2b2.PM.model.login_username, ProjId);
		}
...
i2b2.PM._processLaunchFramework = function() {
	...
	// i2b2 Code Added
	i2b2.PM.view.mLog.showTabsBasedOnRoles(i2b2.PM.model.userRoles);
