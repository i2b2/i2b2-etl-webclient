 ...
 * @namespace	i2b2.CRC.ctrlr.mQryTool
 * @author		Nick Benik, Griffin Weber MD PhD
 * @version 	1.3
 * ----------------------------------------------------------------------------------------
 * updated 9-15-08: RC4 launch [Nick Benik] 
 */
 console.group('Load & Execute component file: CRC > ctrlr > mQryTool');
 console.time('execute time');
 
 
 i2b2.CRC.ctrlr.mQryTool = new MQueryToolController();
 i2b2.CRC.ctrlr.mQryTool.setQueryName;
 
 function MQueryToolController() {
 ...
 //					$('instancevent2['+j + ']').value =i2b2.h.getXNodeVal(sqc[j],'second_query/query_id');
     ...
     this.createDerivedConceptQryRun = function() {
		...
		// display name
		var queryNameInput = $('derivedConceptQryRun').select('INPUT.inputQueryName')[0];
	...
	this._derivedConceptQueryRun = function(inQueryName, options) {
		...
		i2b2.CRC.ctrlr.currentQueryStatus = new i2b2.CRC.ctrlr.MQryStatus($('infoQueryStatusText'));
		i2b2.CRC.ctrlr.currentQueryStatus.startQuery(inQueryName, params);

	}
    //  ================================================================================================== //
	this._derivedConceptPromptRun = function(handleSubmit) {
		if (!i2b2.CRC.view.derivedConceptQryRun) {
			...
			var loopBackSubmit = function() {
				i2b2.CRC.view.derivedConceptQryRun.submitterFunction();
			};
			...
			i2b2.CRC.view.derivedConceptQryRun = new YAHOO.widget.SimpleDialog("derivedConceptQryRun", {
				width: "400px",
				fixedcenter: true,
			...
			$('derivedConceptQryRun').hide();
			i2b2.CRC.view.derivedConceptQryRun.validate = function(){
			...
			i2b2.CRC.view.derivedConceptQryRun.render(document.body);
		}
		// manage the event handler for submit
		delete i2b2.CRC.view.derivedConceptQryRun.submitterFunction;
		i2b2.CRC.view.derivedConceptQryRun.submitterFunction = handleSubmit;
		// display the dialoge
	...
	this.loadDerivedConceptQryRun= function(qryTxt) {
		...
		i2b2.CRC.ctrlr.mQryTool._derivedConceptQueryRun(queryNameInput, options);
	}
