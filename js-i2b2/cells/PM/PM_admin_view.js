...
'</td><td><input type="checkbox" id="RoleDATA_PROT" onClick="i2b2.PM.view.admin.onCheckedChange(\'DATA_PROT\');" name="DATA_PROT">Protected<br><input type="checkbox" id="RoleDATA_DEID" onClick="i2b2.PM.view.admin.onCheckedChange(\'DATA_DEID\');" name="DATA_DEID">De-identified Data<br><input type="checkbox" id="RoleDATA_LDS" onClick="i2b2.PM.view.admin.onCheckedChange(\'DATA_LDS\');" name="DATA_LDS">Limited Data Set<br><input type="checkbox" id="RoleDATA_AGG" onClick="i2b2.PM.view.admin.onCheckedChange(\'DATA_AGG\');"  name="DATA_AGG">Aggregated<br><input type="checkbox" id="RoleDATA_OBFSC"onClick="i2b2.PM.view.admin.onCheckedChange(\'DATA_OBFSC\');"   name="DATA_OBFSC">Obfuscated<br></td><td><input type="checkbox" id="RoleEDITOR" name="EDITOR">Editor<br><input type="checkbox" id="RoleDATA_AUTHOR" onClick="i2b2.PM.view.admin.onCheckedChange(\'DATA_AUTHOR\');" name="DATA_AUTHOR">Data Author<br><input type="checkbox" id="RolePATIENT_FACT_VIEWER" onClick="i2b2.PM.view.admin.onCheckedChange(\'PATIENT_FACT_VIEWER\');"name="PATIENT_FACT_VIEWER">Patient Fact Viewer<br><input type="checkbox" id="RolePOPULATION_FACT_VIEWER" onClick="i2b2.PM.view.admin.onCheckedChange(\'POPULATION_FACT_VIEWER\');" name="POPULATION_FACT_VIEWER">Population Fact Viewer</td></tr>' +
...
i2b2.PM.view.admin.onCheckedChange = function(items) {
	var items = items;
			...
			else 			if (items == "POPULATION_FACT_VIEWER")
			{
				document.getElementById("RoleDATA_AUTHOR").checked = false;
				// document.getElementById("RolePATIENT_FACT_VIEWER").checked = false;		
				document.getElementById("RolePOPULATION_FACT_VIEWER").checked = !!document.getElementById("RolePOPULATION_FACT_VIEWER").checked;			
			}
			else 			if (items == "PATIENT_FACT_VIEWER")
			{
				// document.getElementById("RoleDATA_AUTHOR").checked = false;
				// document.getElementById("RolePOPULATION_FACT_VIEWER").checked = !!document.getElementById("RolePATIENT_FACT_VIEWER").checked;
				document.getElementById("RolePATIENT_FACT_VIEWER").checked = !!document.getElementById("RolePATIENT_FACT_VIEWER").checked;					
			}
			else 			if (items == "DATA_AUTHOR")
			{
				// document.getElementById("RolePATIENT_FACT_VIEWER").checked = !!document.getElementById("RoleDATA_AUTHOR").checked;
				document.getElementById("RolePOPULATION_FACT_VIEWER").checked = !!document.getElementById("RoleDATA_AUTHOR").checked;
				document.getElementById("RoleDATA_AUTHOR").checked = !!document.getElementById("RoleDATA_AUTHOR").checked;							
			}
};
