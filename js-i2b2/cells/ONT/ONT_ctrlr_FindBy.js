		...
		scopedCallback.callback = function(results)
		{
			...
			makeHigherNode = function(parent,key,lvl,fullkey) {
				...
				var renderOptions = {
					...
					click: "i2b2.ONT.view.info.SetKey('"+encodeURI(fullkey)+"', '"+sdxDataNode.origData.derivedCode+"')",
					showchildren: true,
					icon: {
			...
			for(var i2=0;i2<oset.length;i2++) {
				...
				var renderOptions = {
					title: o.name,
					dragdrop: "i2b2.sdx.TypeControllers.CONCPT.AttachDrag2Data",
					click: "i2b2.ONT.view.info.SetKey('"+encodeURI(o.key)+"', '"+sdxDataNode.origData.derivedCode+"')",
					showchildren: true,
					icon: {
